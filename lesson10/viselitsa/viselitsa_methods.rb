...
def get_letters
  ...
  proverka = slovo.split('')

  while proverka.index('ё') != nil do
    proverka[proverka.index('ё')] = 'е'
  end

  while proverka.index('й') != nil
    proverka[proverka.index('й')] = 'и'
  end

  return proverka

  # if proverka.index('ё') == nil
  #   return proverka
  # else
  #   proverka[proverka.index('ё')] = 'е'
  #   return proverka
